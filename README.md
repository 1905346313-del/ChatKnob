...
- 📡 **WiFi 配网**：首次开机自动开启配网热点（`ChatKnob_AP`），通过网页一次性配置 WiFi 和 MQTT 参数
- 💾 **MQTT 参数持久化**：配网时填写的 MQTT 服务器、端口、主题自动保存，断电不丢失
...
| 组件 | 型号/规格 | 数量 |
| :--- | :--- | :--- |
| **主控板** | ESP32 开发板（支持 WiFi 和 I2C 和 PCNT） | 1 |
